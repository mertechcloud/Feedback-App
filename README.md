...
A fully serverless feedback collection application built on AWS cloud services.  
This project demonstrates a decoupled, scalable architecture that processes user feedback through multiple AWS services — **without managing any servers**.

---

## Live Demo

**Access the application here:** http://feedback-static-web9916.s3-website.ca-central-1.amazonaws.com
